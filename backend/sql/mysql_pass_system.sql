-- EduSecure local MySQL schema (paste into MySQL client)
-- MySQL 8+
...
-- Password below corresponds to plain text: EduSecure@1234
...
FROM schools s
JOIN (
  SELECT 'Pat Parker' AS full_name, 'parent@demo.school' AS email, '$2a$12$yTkrlKAxk/AY4Fe2akjwZOcsaGFDczC.nAgv8rU8BiuLx9pm4gR6i' AS password_hash, 'parent' AS role
  UNION ALL SELECT 'Tara Tan', 'teacher@demo.school', '$2a$12$yTkrlKAxk/AY4Fe2akjwZOcsaGFDczC.nAgv8rU8BiuLx9pm4gR6i', 'teacher'
  UNION ALL SELECT 'Adrian Hale', 'admin@demo.school', '$2a$12$yTkrlKAxk/AY4Fe2akjwZOcsaGFDczC.nAgv8rU8BiuLx9pm4gR6i', 'school_admin'
  UNION ALL SELECT 'Devon Kim', 'delegate@demo.school', '$2a$12$yTkrlKAxk/AY4Fe2akjwZOcsaGFDczC.nAgv8rU8BiuLx9pm4gR6i', 'delegate'
  UNION ALL SELECT 'Sam Root', 'sysadmin@demo.school', '$2a$12$yTkrlKAxk/AY4Fe2akjwZOcsaGFDczC.nAgv8rU8BiuLx9pm4gR6i', 'system_admin'
  UNION ALL SELECT 'Officer Vance', 'security@demo.school', '$2a$12$yTkrlKAxk/AY4Fe2akjwZOcsaGFDczC.nAgv8rU8BiuLx9pm4gR6i', 'gate_security'
) AS x
WHERE s.code = 'DEMO'
